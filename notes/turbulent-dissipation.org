...
- So this is really important. I think the condition will be easily satisfied in H II regions
  - No, not true: the gyrofrequency is larger than the collision frequency I think
...
9. Pope then relates this to the Kolmogorov scale \eta, defined as (p. 185)
   - \eta \equiv (\nu^3 / \epsilon)^{1/4} 
...
- [ ] What is the origin of the 3/4 power?
  - Does this depend on the incompressibility assumption?
...
*** Donzis & Panickacheril John 2020
Title: /Universality and scaling in homogeneous compressible turbulence/

They find that the dilatational Mach number is more important than the total turbulent Mach number. They find better universa scaling relations by separating out the solenoidal and dilataional components.
*** Panickacheril John et al 2021
